...
public class LocalStorageProvider extends DocumentsProvider {
    ...
    private final static String[] DEFAULT_ROOT_PROJECTION = new String[] {
            ...
            DocumentsContract.Root.COLUMN_FLAGS, DocumentsContract.Root.COLUMN_TITLE, DocumentsContract.Root.COLUMN_DOCUMENT_ID, Root.COLUMN_ICON,
    ...
    private void includeFile(final MatrixCursor result, final File file)
        ...
        int flags = file.canWrite() ? DocumentsContract.Document.FLAG_SUPPORTS_DELETE | Document.FLAG_SUPPORTS_WRITE
                : 0;
